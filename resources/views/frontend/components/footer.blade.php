                ...
                <div class="flex items-center gap-3 pt-2">
                    @if(isset($mainCompany) && $mainCompany->website)
                        <a href="{{ Str::startsWith($mainCompany->website, ['http://', 'https://']) ? $mainCompany->website : 'https://' . $mainCompany->website }}" 
                           ...
                           class="px-3 py-1.5 rounded-lg bg-[#050e05] border border-[#93F514]/40 flex items-center gap-2 text-xs font-semibold text-gray-300 hover:text-[#93F514] hover:border-[#93F514] transition">
                    ...
                    {{-- @if(isset($mainCompany) && $mainCompany->website)
                        ...
                        <li class="flex items-center gap-2.5">
                            ...
                            <a href="{{ $footerWebUrl }}" 
                               target="_blank" 
                               rel="noopener noreferrer"
                               class="text-gray-300 hover:text-[#93F514] transition truncate max-w-[200px]"
