                    ...
                    <div class="space-y-6 text-xs max-h-[75vh] overflow-y-auto pr-1 custom-scrollbar">
                        ...
                        <template x-if="detailData.applicant_profile && detailData.applicant_profile.generated_cv_url">
                            <div class="pt-3 border-t border-gray-100 dark:border-slate-800 flex items-center justify-between">
                                <span class="font-bold text-gray-900 dark:text-white text-xs">Dokumen CV / Resume Pelamar</span>
                                <a :href="detailData.applicant_profile.generated_cv_url" target="_blank" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold rounded-xl shadow-sm transition">
                                    Buka File CV
                                </a>
                            </div>
                        </template>
