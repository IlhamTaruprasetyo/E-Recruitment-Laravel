                        ...
                        <tr class="hover:bg-gray-50/80 dark:hover:bg-slate-700/30 transition duration-150">
                            ...
                            <td class="py-4 px-6">
                                ...
                                @elseif ($emp->employee_type === 'contract')
                                    <span class="px-2.5 py-1 rounded-lg bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 font-semibold text-[11px] border border-blue-200 dark:border-blue-800/60">
                                        Kontrak
                                    </span>
                                @elseif ($emp->employee_type === 'probation')
                                    <span class="px-2.5 py-1 rounded-lg bg-purple-50 dark:bg-purple-950/40 text-purple-700 dark:text-purple-300 font-semibold text-[11px] border border-purple-200 dark:border-purple-800/60">
                                        Probation
                                    </span>
                                @else
                                    <span class="px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-slate-700/60 text-slate-700 dark:text-slate-200 font-semibold text-[11px] border border-slate-200 dark:border-slate-600">
                                        Tetap
                                    </span>
                                @endif
                            </td>
                                ...
                                <div class="flex items-center justify-end gap-2">
                                     @if ($emp->employee_type === 'internship')
                                         <button wire:click="openPromoteModal({{ $emp->id }})" 
                                                 class="px-2.5 py-1 rounded-xl bg-amber-50 hover:bg-amber-100 dark:bg-amber-950/40 dark:hover:bg-amber-900/50 text-amber-700 dark:text-amber-300 border border-amber-200/80 dark:border-amber-800/60 font-semibold text-[11px] transition-all flex items-center gap-1.5 active:scale-95" 
