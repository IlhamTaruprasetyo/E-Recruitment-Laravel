<div class="space-y-6" x-data="{ 
    ...
    <div class="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 overflow-hidden shadow-sm rounded-2xl p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
            ...
            <button @click="showCreateModal = true" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-semibold shadow-md shadow-indigo-500/20 transition-all flex items-center justify-center gap-2 shrink-0 self-start sm:self-auto">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Filter Toolbar -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-4 border-t border-gray-100 dark:border-slate-800">
            <!-- Search -->
    ...
    <div class="relative bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
        ...
        <div wire:loading wire:target="search, companyFilter, previousPage, nextPage, gotoPage" class="absolute inset-0 bg-white/60 dark:bg-slate-900/60 backdrop-blur-[1px] flex items-center justify-center z-10 transition">
                        ...
                        <tr class="hover:bg-gray-50/80 dark:hover:bg-slate-800/40 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                @if ($department->company)
                                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-medium bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-300 border border-gray-200 dark:border-slate-700">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-gray-400 dark:text-slate-500">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <span class="text-xs">Klik tombol "Tambah Departemen" untuk menambahkan data baru.</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.department.store') }}" method="POST" @submit="isSubmittingCreate = true" class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" placeholder="Penjelasan mengenai tugas atau divisi ini..." class="w-full px-3 py-2 text-xs rounded-xl bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-[11px] text-rose-500">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="p-6">
                    ...
                    <form :action="'/admin/departments/' + editData.id" method="POST" @submit="isSubmittingEdit = true" class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="edit_name" x-model="editData.name" placeholder="Nama Departemen" class="w-full px-3 py-2 text-xs rounded-xl bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition">
                        </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        <p class="text-xs text-gray-600 dark:text-slate-300">
                            Apakah Anda yakin ingin menghapus data departemen <strong class="text-gray-900 dark:text-white font-semibold" x-text="deleteData.name"></strong>?
                        </p>
                    </div>
